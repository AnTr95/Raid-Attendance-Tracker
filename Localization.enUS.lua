...
L.SETUP_PUNISH_CALENDAR_TOOLTIP = "|cFFFF0000Disabled in Classic|r\nThis determines if players who did not answer or put tentative should have the first attendance point removed and be a miss instead.\n\nThis is to incentivice players to accept the calendar on time.\n\nDefault is off.";
