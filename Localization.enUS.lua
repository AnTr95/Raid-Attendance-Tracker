...
L.HELP1 = "All commands must be sent through whispers (not Battle.net). Whisper !rat myrank to a RAT officer to get your Rank, AP (attendance points), M (missed points) and attendance %.";
L.HELP2 = "Commands you can whisper a RAT officer: !rat myrank - your current standing. !rat bench - bench yourself so you can leave the raid. !rat alt Main - bind this character as an alt of Main.";
...
L.MYRANK3 = " - M: ";
L.MYRANK4 = " - ";
L.MYRANK_NONE = "You are not tracked yet.";

L.OPTIONS_LEFT_BUTTON = "<----  Back";
L.OPTIONS_PAGE_TEXT1 = "Step ";
L.OPTIONS_PAGE_TEXT2 = " /7";
...
L.OPTIONS_OFFICER_RANKS_TEXT = "Accept data updates from these ranks (officers):";
...
L.OPTIONS_OFFICER_RANKS_TITLE = "OFFICER RANKS";
...
L.SETUP_OR_INFO_TEXT = "Check the ranks whose members are allowed to change attendance data (your officers). Data coming from these ranks is trusted and synced; data from any other rank is ignored, which prevents tampering. It is recommended to scan for the standard officer ranks, then adjust.";
